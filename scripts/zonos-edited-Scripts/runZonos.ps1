# $logFile = "$PSScriptRoot\run_gradio.log"
# "[$(Get-Date -Format 'HH:mm:ss')] run_gradio.ps1 start" | Out-File -FilePath $logFile -Encoding utf8
...
# "[$(Get-Date -Format 'HH:mm:ss')] run_gradio.ps1 end" | Out-File -FilePath $logFile -Encoding utf8 -Append

Write-Output "Starting gradio_interface.py"
